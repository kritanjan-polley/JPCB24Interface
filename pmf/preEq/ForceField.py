...
class ForceField:
    ...
    def print(self, fname=None):
        ...
        if self._pol_string:
            ...
            printer('pair_style lj/cut/thole/long 2.6 12.0')
        ...
        printer('# Pair Potential Coefficients (i j epsilon_ij sigma_ij alpha_ij)')
        for i, r in self._coefficients.iterrows():
            printer('pair_coeff %2d %2d %8.5f %8.5f %8.5f # %s' % (i[0], i[1], r.epsilon, r.sigma, r.alpha, r.label))
        printer('')
